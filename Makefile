...
CFLAGS=-I. -O9 -mpentium $(RAWKEYFLAGS)
endif

ifdef DJ
DJDIR=c:/dj
CFLAGS=-I. -I$(DJDIR)/include -O0 -m386 $(RAWKEYFLAGS) -L$(DJDIR)/lib
endif
...
mz800em.exe: $(MZ800EM_OBJS)
	$(LD) $(MZ800EM_OBJS) -o mz800em.exe $(DJDIR)/lib/crt0.o \
		-L$(DJDIR)/lib -lvga -lc -lgcc -lemu
...
FILES = COPYING ChangeLog Makefile README README-700 TODO BUGS \
	cbops.c edops.c font.txt mzterm.c \
