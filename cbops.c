...

{
   ...
   case  4: rlc(h); break;
   case  5: rlc(l); break;
   case  6: INC_TSTATES(7);val=load(addr);rlc(val);store(addr,val);break;
   case  7: rlc(a); break;
   case  8: rrc(b); break;
   case  9: rrc(c); break;
   case 10: rrc(d); break;
   ...
   case 12: rrc(h); break;
   case 13: rrc(l); break;
   case 14: INC_TSTATES(7);val=load(addr);rrc(val);store(addr,val);break;
   case 15: rrc(a); break;
   ...
   case 0x16: INC_TSTATES(7);val=load(addr);rl(val);store(addr,val);break;
   ...
   case 0x1e: INC_TSTATES(7);val=load(addr);rr(val);store(addr,val);break;
   ...
   case 0x26: INC_TSTATES(7);val=load(addr);sla(val);store(addr,val);break;
   ...
   case 0x2e: INC_TSTATES(7);val=load(addr);sra(val);store(addr,val);break;
   ...
   case 0x36: INC_TSTATES(7);val=load(addr);sll(val);store(addr,val);break;
   ...
   case 0x3e: INC_TSTATES(7);val=load(addr);srl(val);store(addr,val);break;
   case 0x3f: srl(a); break;
      ...
      case 0x46: INC_TSTATES(4);val=load(addr);bit(n,val);/*store(addr,val);*/break;
      ...
      case 0x86: INC_TSTATES(4);val=load(addr);res(n,val);store(addr,val);break;
      ...
      case 0xc6: INC_TSTATES(4);val=load(addr);set(n,val);store(addr,val);break;
